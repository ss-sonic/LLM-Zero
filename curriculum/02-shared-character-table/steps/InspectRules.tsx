  ...
  return (
    <div className="screen-layout centered-screen wide-screen l2-screen">
      <div className="screen-copy centered-copy compact-copy">
        ...
        <h2>The number did not change. The rule did.</h2>
        <p className="lead">Compare the two private tables. Look specifically for the number <strong>12</strong>.</p>
      </div>
      ...
      <div className="l2-question-block">
        <p className="question-label">Why did Computer 2 show B?</p>
        ...
        {answer === "rules" && (
          <div className="feedback success-feedback">
            <div><b>Exactly.</b><span>A representation only works between systems when they share the rule used to interpret it.</span></div>
