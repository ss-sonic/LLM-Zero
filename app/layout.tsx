...
export const metadata: Metadata = {
  title: { default: title, template: "%s · LLM Zero" },
  description,
  applicationName: "LLM Zero",
  category: "education",
  keywords: ["LLM", "large language models", "AI education", "machine learning", "transformers", "first principles", "interactive learning", "open source education"],
  creator: "LLM Zero contributors",
  publisher: "LLM Zero",
  manifest: "/manifest.webmanifest",
  icons: { icon: [{ url: "/icon.svg", type: "image/svg+xml" }], shortcut: "/icon.svg" },
  openGraph: { type: "website", title, description, siteName: "LLM Zero" },
